...
if($_SESSION['is_admin'] == true) {
    $sql = "SELECT  movies.movie_name, users.email, booking.id, booking.nr_tickets, booking.date, booking time FROM movies
    INNER JOIN bookings ON movies.id = booking.movie_id
...
$selectMovies = $conn->prepare($sql);
$selectMovies->bindparam(":user_id" ,$user_id);
$selectMovies->execute();

$booking_data = $selectBookings->fetch();
